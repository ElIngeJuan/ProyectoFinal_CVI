...
private:
    ...
    // En Tutorial22_HybridRendering.hpp
    // En Tutorial22_HybridRendering.hpp
    float3 m_CubePos             = float3(0.0f, 1.0f, 0.0f);
    float  m_CubeSpeed           = 5.0f;
    int    m_ControlledCubeIndex = -1;
    ...
    struct Scene
    {
        ...
        RefCntAutoPtr<ITexture>              ReflectionMap;     // Para la textura de reflexión
        RefCntAutoPtr<ISampler>              ReflectionSampler; // Para el sampler de reflexión
